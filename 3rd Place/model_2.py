...
def run_train(gpus):
    ...
    train_v2(args, size=896)


def run_eval():
    args = argparse.Namespace(
        pretraining="data/working/models/v13_regnety120/model_199.pth",
        valid_sub_dir="valid",
        test_sub_dir="test",
        dataset_dir="data/train-orig-resolution",
        rgb_suffix="tif",
...
def run_test(gpus):
    ...
    args = argparse.Namespace(
        ...
        rgb_suffix="j2k",
        random_crop=False,
        model_path=f"data/working/models/{model_name}/model_199.pth",
        gpus=gpus,
        augmentation=False,
        batch_size=1,
        num_workers=1,
